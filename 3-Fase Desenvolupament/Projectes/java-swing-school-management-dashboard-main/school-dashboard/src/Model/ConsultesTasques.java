...
public class ConsultesTasques extends Conexio {
    ...
    public void UsuariAssignat(int i) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (i == 1) {
                    ...
                    //  ComboUsuariAssignat2.addItem(rs.getString("usuari"));
                } else {

                    //   ComboUsuariAssignat.addItem(rs.getString("usuari"));
                    //  ComboUsuariAssignatOrdinador1.addItem(rs.getString("usuari"));
                }
    ...
    public void UsuariAssignat1(int i) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (i == 2) {
                    ...
                    //jComboBoxDashTasquesUsuari.addItem(rs.getString("usuari"));
                }
