...
public class Main extends javax.swing.JFrame {
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int menuIndex, int subMenuIndex) {
                ...
                if (menuIndex == 1) {
                    ...
                    //ft.setVisible(true);
                    //main.showForm(new FormTasques());
                    // main.showForm(new FormTasques());
                    /* ConsultesTasques ct = new ConsultesTasques();
                    Tasques t = new Tasques();
                    ControladorTasques con = new ControladorTasques(ft, ct, t);
                    con.inicialitzar();
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        //FormTasques ft = new FormTasques();
        //formTasques = ft;
       // formTasques.setVisible(true);
        //JFPrincipal principal = new JFPrincipal();
        //Login mod = new Login();
        //ConsultesLogin modC = new ConsultesLogin();
        //JFLogin vist = new JFLogin();
        //ControladorLogin con = new ControladorLogin(mod, modC, vist, main, contrasenya, jf);
        //con.inicialitzar();
