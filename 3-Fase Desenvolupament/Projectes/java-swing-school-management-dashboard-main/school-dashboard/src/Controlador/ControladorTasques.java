...
import com.raven.form.FormTasques;
 ...
 * @author Victor
 */
public class ControladorTasques extends FormTasques implements ActionListener, MouseListener, KeyListener {

    public Tasques mod;
    public ConsultesTasques modC;
    // public FormTasques vis;

    public DefaultTableModel modelTasques;

    public ControladorTasques(ConsultesTasques modC, Tasques mod) {

        this.mod = mod;
        this.modC = modC;
        // this.vis = vis;

        jButtonNovaTasca.addActionListener(this);
        // this.vis.jButtonRegistarTasca.addActionListener(this);
        // this.vis.jButtonEditarTasca.addActionListener(this);
        jButtonEliminarTasca.addActionListener(this);
//        this.vis.jTable_Tasques.addMouseListener(this);
        ...
        txtBuscadorTasques.addKeyListener((KeyListener) this);
        // this.vis.jButtonTascaNormal.addMouseListener(this);
        // this.vis.jButtonTascaRepeticio.addMouseListener(this);
        //  this.vis.jComboBoxDashTasquesUsuari.addItemListener((ItemListener) this);
        ...
        //  this.vis.jButtonAfegirUsuari2.addActionListener(this);
        // this.vis.jButtonAfegirUsuari3.addActionListener(this);
        // this.vis.jButtonChat.addActionListener(this);
    ...
    public void inicialitzar() {
        ...
        MostrarTaula(jTable_Tasques);
        DefaultComboBoxModel mdl = new DefaultComboBoxModel();
        mdl.removeAllElements();
        jComboBoxDashTasquesUsuari.setModel(mdl);
        modC.UsuariAssignat1(2);
...
//    @Override
    public void itemStateChanged(ItemEvent e) {
        ...
        if (e.getSource() == jComboBoxDashTasquesUsuari) {

            String query = jComboBoxDashTasquesUsuari.getSelectedItem().toString();
            System.out.print("UsariAssignat" + query);

            TableRowSorter<TableModel> sorter = new TableRowSorter<TableModel>(((DefaultTableModel) jTable_Tasques.getModel()));
            ...
            System.out.println("Column COUNT" + jTable_Tasques.getRowCount());
...
//                System.out.println("SORT KEY" + vis.jTable_Tasques.getModel().getValueAt(i, 1));
                String usuaris = (String) jTable_Tasques.getValueAt(i, 3);
                String[] parts = usuaris.split("<br>");
                int aux = 40;
                for (int j = 1; j < parts.length; j++) {
                    jTable_Tasques.setRowHeight(i, aux);
                    aux = aux + 15;
    ...
    public void actionPerformed(ActionEvent e) {
         if (e.getSource() == vis.jButtonChat) {
        ...
        if (e.getSource() == vis.jButtonAfegirUsuari2) {
            ...
            if (!UsuariArrayList.contains(usuari)) {
                ...
                vis.jTextUsuariAssignat2.setText(line);

            }

        }

        if (e.getSource() == vis.jButtonAfegirUsuari3) {

            System.out.println("Usari:" + vis.ComboUsuariAssignat3.getSelectedItem());
            String usuari = (String) vis.ComboUsuariAssignat3.getSelectedItem();
            ArrayList<String> UsuariArrayList = mod.getUsuariArrayList();
            String line = "";
            ...
            if (!UsuariArrayList.contains(usuari)) {
                ...
                vis.jTextUsuariAssignat3.setText(line);
...
//    @Override
    public void keyReleased(java.awt.event.KeyEvent evt) {
        ...
        TableRowSorter<TableModel> sorter = new TableRowSorter<TableModel>(((DefaultTableModel) jTable_Tasques.getModel()));
        sorter.setRowFilter(RowFilter.regexFilter(txtBuscadorTasques.getText()));
        jTable_Tasques.setRowSorter(sorter);
        for (int i = 0; i < jTable_Tasques.getRowCount(); i++) {

            System.out.println("SORT KEY" + jTable_Tasques.getModel().getValueAt(i, 1));
            String usuaris = (String) jTable_Tasques.getValueAt(i, 3);
            String[] parts = usuaris.split("<br>");
            int aux = 40;
            for (int j = 1; j < parts.length; j++) {
            ...
            if (fila_point > -1 && columna_point > 0) {
                ...
                switch (modC.informacioTasca(mod)) {
                    ...
                    case 2:
                        ...
                        String string1 = mod.getUsuariArrayList().get(0);
                        String[] parts1 = string1.split(",");
                        for (int i = 0; i < parts1.length; i++) {

                            text1 = text1 + parts1[i] + "\n";

                        }
                        vis.jTextUsuariAssignat3.setText(text1);
            ...
            if (fila_point > -1 && columna_point > 0) {
                ...
                if (mod.getTipusGrup() == false) {
                    ...
                    if (Celm.informacioElement(elm) == 1) {
                        ...
                        System.out.println("Element" + elm.getElement());
                        if (elm.getElement().equals("Ordinador")) {
                            vis.DashInfoTasca.setVisible(false);
                            ...
                            vis.txt_nomElem1.setText(elm.getNom());
                            vis.ComboUsuariAssignatOrdinador1.setSelectedItem(elm.getUsuariAssignat());
                            vis.txt_observacions1.setText(elm.getObservacions());
                            vis.ComboTipus1.setSelectedItem(elm.getTipus());
                            vis.ComboEstatElem1.setSelectedItem(elm.getEstat());
                            vis.txt_marca1.setText(elm.getMarca());
                            vis.txt_numserie1.setText(elm.getNumeroSerie());
                            vis.txt_model1.setText(elm.getModel());
                            System.out.println(elm);
                            String d3 = elm.getData();
                            String date3 = d3.substring(0, 10);
                            String data3 = date3.replace("-", "/");
                            System.out.println("DATAASAAAAAAAA:" + d3);
                            System.out.println("sSubCadena:" + date3);
                            ...
                            vis.dataIngresOrdinador1.setDate(localDate);

                            if (elm.getAdquisicio().equals("Compra")) {
