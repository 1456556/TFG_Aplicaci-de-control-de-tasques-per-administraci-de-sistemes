...
public class ControladorLogin extends JFPrincipal implements ActionListener {
    ...
    public ControladorLogin(Login mod, ConsultesLogin modC, JFLogin vis, Main main, JFContrasenya contrasenya, JFileChooser jf) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vis.btnEntrar) {
            ...
            if (modC.login(mod) == 0) {
                ...
                // ControladorMenu con = new ControladorMenu(main, contrasenya, jf);
                // con.inicialitzar();
                //Login no exitós
            } else {
