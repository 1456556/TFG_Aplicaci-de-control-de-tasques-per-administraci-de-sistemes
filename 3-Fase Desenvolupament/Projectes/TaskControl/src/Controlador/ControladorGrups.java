...
public class ControladorGrups implements ActionListener, MouseListener, KeyListener {
    ...
    public ControladorGrups(Grups mod, ConsultesGrups modC, JFPrincipal2 vis) {
        ...
        this.vis.txt_cerca2.addKeyListener(this);
        this.vis.txtBuscadorGrups.addKeyListener(this);
    ...
    public void MostrarTaulaGrupsUsuaris() {
        ...
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);
        for (int i = 0; i < vis.jTableCrearGrupsUsuaris.getColumnCount(); i++) {

            vis.jTableCrearGrupsUsuaris.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
    ...
    public void MostrarTaulaGrupsElements() {
        ...
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);
        for (int i = 0; i < vis.jTableCrearGrupsElements.getColumnCount(); i++) {

            vis.jTableCrearGrupsElements.getColumnModel().getColumn(i).setCellRenderer(centerRenderer);
    ...
    public void keyReleased(java.awt.event.KeyEvent evt) {
        ...
        if (evt.getSource() == vis.txt_cerca2) {

            TableRowSorter<TableModel> sorter1 = new TableRowSorter<TableModel>(((DefaultTableModel) vis.jTableCrearGrups.getModel()));
            sorter1.setRowFilter(RowFilter.regexFilter(vis.txt_cerca2.getText()));
            vis.jTableCrearGrups.setRowSorter(sorter1);

        }

        if (evt.getSource() == vis.txtBuscadorGrups) {

            TableRowSorter<TableModel> sorter3 = new TableRowSorter<TableModel>(((DefaultTableModel) vis.jTable_Grups.getModel()));
            sorter3.setRowFilter(RowFilter.regexFilter(vis.txtBuscadorGrups.getText()));
            vis.jTable_Grups.setRowSorter(sorter3);
