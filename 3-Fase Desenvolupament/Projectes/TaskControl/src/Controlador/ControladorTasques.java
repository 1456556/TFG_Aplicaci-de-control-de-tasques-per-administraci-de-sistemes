 ...
 * @author Victor
 */
public class ControladorTasques extends JFPrincipal2 implements ActionListener, MouseListener, KeyListener, ItemListener {
    ...
    public ControladorTasques(Tasques mod, ConsultesTasques modC, JFPrincipal2 vis) {
        ...
        this.vis.jButtonChat1.addActionListener(this);
        ...
        vis.jLabelvegades.setVisible(false);
...
//                System.out.println("SORT KEY" + vis.jTable_Tasques.getModel().getValueAt(i, 1));
    ...
    public void NotificacioTasca(int id) {
        ...
        switch (modC.informacioTasca(mod)) {
            ...
            case 1:
                ...
                System.out.println("Usuari Assignat" + mod.getUsuariArrayList() + "sizw" + mod.getUsuariArrayList().size());

                if (mod.getGrupAfectat().equals("--------")) {
                    System.out.println("GRUP AFECTAT");
                ...
                System.out.println("Separats1 " + mod.getUsuariArrayList().get(0));

                String string = mod.getUsuariArrayList().get(0);
                String[] parts = string.split(",");

                vis.jButtonChat.setVisible(false);
                String auxx = parts[0];
                if (auxx.contains("\n")) {
                    vis.jButtonChat.setVisible(true);
            ...
            case 2:
                ...
                if (mod.getGrupAfectat().equals("--------")) {
                    ...
                    vis.jScrollPane7.setVisible(false);

                } else {
                    vis.jScrollPane7.setVisible(true);
                ...
                vis.jButtonChat1.setVisible(false);
                String auxxx = parts1[0];
                if (auxxx.contains("\n")) {
                    vis.jButtonChat1.setVisible(true);
                ...
                if (mod.getTipus().equals("Diari")) {
                    ...
                    vis.jCheckBoxDilluns1.setVisible(false);
                    vis.jCheckBoxDimarts1.setVisible(false);
                    vis.ComboMes1.setVisible(false);
                    vis.ComboMesNumero1.setVisible(false);
                    vis.ComboMesDia1.setVisible(false);
                    vis.jRadioButtonEl1.setVisible(false);
                }
                ...
                if (mod.getTipus().equals("Mensual")) {
                    ...
                    vis.jCheckBoxDilluns1.setVisible(false);
                    vis.jCheckBoxDimarts1.setVisible(false);
                    vis.ComboMesNumero1.setVisible(true);
                    vis.ComboMesDia1.setVisible(true);
                    vis.jRadioButtonEl1.setVisible(true);
                    vis.ComboMes1.setVisible(false);
                }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vis.jButtonChat1) {
        ...
        if (e.getSource() == vis.jButtonEditarTascaRecurrent) {
            ...
            if (vis.jCheckBoxNotificacio22.isSelected()) {
