...
public class ControladorUsuaris implements ActionListener, MouseListener, KeyListener {
    ...
    public ControladorUsuaris(Usuaris mod, ConsultesUsuaris modC, JFPrincipal2 vis) {
        ...
        this.vis.txtBuscadorUsuari.addKeyListener(this);
    }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        System.out.print("Buscador" + vis.txtBuscadorUsuari.getText());
        System.out.println("Nom" + mod.getNom());

        int numRegistres = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).size();

        for (int i = 0; i < numRegistres; i++) {

            columna[1] = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).get(i).getNom();
            columna[2] = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).get(i).getCognom();
            columna[3] = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).get(i).getUsuari();
            columna[4] = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).get(i).getNivell();
            columna[5] = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).get(i).getEstat();
            columna[6] = modC.BuscarUsuaris(vis.txtBuscadorUsuari.getText()).get(i).getId();
            model_usuaris.addRow(columna);
