...
public class Ventana implements ActionListener {
    ...
    public Ventana(int operacion, ArrayList usuari) {
        statusOp = operacion;
        salida = 0;
        ...
        for (int i = 0; i < usuari.size(); i++) {
            ...
            contactos.add((String) usuari.get(i));
            contactosChat.add((String) usuari.get(i));
        }

        System.out.println("usuariss" + contactos);
