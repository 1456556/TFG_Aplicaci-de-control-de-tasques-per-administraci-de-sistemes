 ...
 * @author Victor
 */
public class JFLogin2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 90, -1));

        txtUsuari.setBackground(new java.awt.Color(255, 255, 255));
        txtUsuari.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtUsuari.setForeground(new java.awt.Color(0, 0, 0));
        txtUsuari.setBorder(null);
        jPanel1.add(txtUsuari, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 290, 320, -1));

        jSeparator2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 310, 320, 10));

        jLabel2.setBackground(new java.awt.Color(255, 153, 51));
        jLabel2.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Contrasenya:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, 190, 30));

        txtContrasenya.setBackground(new java.awt.Color(255, 255, 255));
        txtContrasenya.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        txtContrasenya.setForeground(new java.awt.Color(0, 0, 0));
        txtContrasenya.setBorder(null);
        jPanel1.add(txtContrasenya, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 460, 330, -1));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 480, 330, 10));

        btnRegistre.setBackground(new java.awt.Color(255, 255, 255));
        btnRegistre.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        btnRegistre.setForeground(new java.awt.Color(4, 72, 210));
        ...
        jPanel1.add(btnRegistre, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 600, 639, -1));

        btnEntrar.setBackground(new java.awt.Color(160, 160, 160));
        ...
        jPanel1.add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 670, 260, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFLogin2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
