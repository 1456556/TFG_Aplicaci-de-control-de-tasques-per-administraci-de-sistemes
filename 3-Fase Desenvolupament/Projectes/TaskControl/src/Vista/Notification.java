...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(Frame fram, Type type, Location location, String message, int aux, String titol, String missatge) {
        this.fram = fram;
        this.type = type;
            ...
            public void begin() {
                if (!showing) {
                    ...
                    if (location == Location.TOP_CENTER) {
                        ...
                        x = fram.getX() + fram.getWidth() - dialog.getWidth() - margin;
                        y = fram.getY() + fram.getHeight() - dialog.getHeight() - aux;
                        top_to_bot = false;
