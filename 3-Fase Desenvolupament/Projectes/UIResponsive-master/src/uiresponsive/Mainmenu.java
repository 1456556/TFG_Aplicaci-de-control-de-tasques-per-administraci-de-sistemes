...
public class Mainmenu extends javax.swing.JFrame {
    ...
    public Mainmenu() {
        ...
        ImageIcon wallapper_logo = new ImageIcon("src/images/delete_32px.png");
        Icon icono_logo = new ImageIcon(wallapper_logo.getImage().getScaledInstance(buttonhidemenu.getWidth(),buttonhidemenu.getHeight(), Image.SCALE_DEFAULT));
        buttonhidemenu.setIcon(icono_logo);
        this.repaint();
    }
