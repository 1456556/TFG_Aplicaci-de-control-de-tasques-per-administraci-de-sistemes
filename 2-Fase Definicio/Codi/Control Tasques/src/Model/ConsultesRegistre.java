                ...
                if (validacio == 0) {
                    try {
                        ...
                        if (mather.find() == false) {
                            ...
                            PreparedStatement pst2 = cn2.prepareStatement("insert into Usuaris (nom, cognom, telefon, email, usuari, contrassenya, nivell, estat) values (?,?,?,?,?,?,?,?)");

                            pst2.setString(1, nom);
                            pst2.setString(2, cognom);
                            pst2.setString(3, telefon);
                            pst2.setString(4, correu);
